...
const Header: FC<HeaderProps> = (props) => {
  return (
    <div className="py-32 gradient-header">
      <div className="container mx-auto max-w-md flex flex-col items-center px-4 md:px-0">
        <Image
          width="192"
          height="192"
          className="rounded-full shadow-xl w-48 h-48"
        ...
        <div className="flex flex-row space-x-2 mt-8">
          <a
            ...
            className="block group border border-gray-400 rounded-full py-3 px-3 text-gray-700 text-xs font-light hover:border-black hover:text-white transition duration-300 hover:shadow-lg hover:bg-black"
          >
            <svg
          ...
          <a
            href="https://github.com/samwightt/"
            className="block group border border-gray-400 rounded-full py-3 px-3 text-gray-700 text-xs font-light hover:border-black hover:text-white transition duration-300 hover:shadow-lg hover:bg-black"
          >
            <svg
              className="w-5 h-5 fill-current"
