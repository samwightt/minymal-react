...
const Footer: FC<FooterProps> = (props) => {
  return (
    <footer>
      <div className="flex space-x-4 flex-row px-8 py-6 md:px-16 bg-white justify-between items-center border-t border-gray-200">
        <Link href="/">
        ...
        <div className="flex flex-row space-x-2">
          <a
            ...
            className="block group border border-gray-400 rounded-full py-2 px-2 text-gray-700 text-xs font-light hover:border-black hover:text-white transition duration-300 hover:shadow-lg hover:bg-black"
          >
            <svg
